...
export default async function HeroCard(){
  ...
  const bio = val(map.hero_bio, 'You will begin to realise why this exercise is called the Dickens Pattern (with reference to the ghost showing Scrooge some different futures).');
      ...
      <section className="container floating-wrap">
        <div className="floating-card">
          <div className="card-grid">
            ...
            <div>
              <div className="eyebrow reveal delay-1">HELLO EVERYBODY, I AM</div>
              <div className="name reveal delay-2" style={{ textTransform:'uppercase' }}>{name}</div>
              <div className="role reveal delay-2" style={{ textTransform:'uppercase', fontSize:14 }}>{title}</div>
              <p className="bio reveal delay-3">{bio}</p>

              <div className="info reveal delay-4">
              ...
              <div className="social reveal delay-4">
